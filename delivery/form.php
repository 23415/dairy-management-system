...
<form action='' method='POST' class="form-horizontal" name="delivery"> 
    <div class="control-group">
        ...
        <div class="controls">
            <input id="f_no" class="input-xlarge" type="text" placeholder="FA**" name='r_f_no' value='<?php echo isset($row)?stripslashes($row['r_f_no']):''; ?>'/> 
    ...
    <div class="control-group">
        <label class="control-label" for="r_kg"> Milk in litre:</label >
        <div class="controls">
            <input class="input-xlarge" type="text" placeholder="" name='r_kg' value='<?php echo isset($row)?stripslashes($row['r_kg']):''; ?>'/> 
