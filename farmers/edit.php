...
<a href='index.php' class='btn btn-primary'>Back To Listing</a>
    <form action='' method='POST' class="form-horizontal"> 
        <div class="control-group">
            ...
            <div class="controls">
                <input class="input-xlarge" type="text"  name='f_no' value='<?php echo stripslashes($row['f_no']) ?>'/> 
            </div>
        </div>
        <div class="control-group">
            <label class="control-label" for="f_id"> ID NO:</label >
            <div class="controls">
                <input class="input-xlarge" type="text"  name='f_id' value='<?php echo stripslashes($row['f_id']) ?>'/> 
            </div>
        </div>
        <div class="control-group">
            <label class="control-label" for="f_name"> Name of Farmer:</label >
            <div class="controls">
                <input class="input-xlarge" type="text"  name='f_name' value='<?php echo stripslashes($row['f_name']) ?>'/> 
            </div>
        </div>
        <div class="control-group">
            <label class="control-label" for="f_locallity"> Locality of Farmer:</label >
            <div class="controls">
                <input class="input-xlarge" type="text" ." name='f_locallity' value='<?php echo stripslashes($row['f_locallity']) ?>'/> 
            </div>
        </div>
        <div class="control-group">
            <label class="control-label" for="f_ac"> Farmer's A/C NO:</label >
            <div class="controls">
                <input  class="input-xlarge" type="text"  name='f_ac' value='<?php echo stripslashes($row['f_ac']) ?>' /> 
            </div>
        </div>
        <div class="control-group">
            <label class="control-label" for="f_phone"> Farmer Phone NO:</label >
            <div class="controls">
                <input class="input-xlarge" type="text"  name='f_phone'  value='<?php echo stripslashes($row['f_phone']) ?>' /> 
            </div>
        </div>
        <div class="control-group">
