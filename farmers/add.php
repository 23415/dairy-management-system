...
<form action='' method='post' class="form-horizontal"> 
    <div class="control-group">
        ...
        <div class="controls">
            <input class="input-xlarge" type="text" placeholder="" name='f_no'/>
<?php echo $validation['no'] ?>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input class="input-xlarge" type="text" placeholder="" name='f_id'/> 
<?php echo $validation['id'] ?>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input class="input-xlarge" type="text" placeholder="" name='f_name'/> 
        </div>
    </div>
    <div class="control-group">
        <label class="control-label" for="f_locallity"> Locality of Farmer:</label >
        <div class="controls">
            <input class="input-xlarge" type="text" placeholder="" name='f_locallity'/> 
        </div>
    </div>
    <div class="control-group">
        <label class="control-label" for="f_ac"> Farmer's A/C NO:</label >
        <div class="controls">
            <input  class="input-xlarge" type="text" placeholder="" name='f_ac'/> 
        </div>
    </div>
    <div class="control-group">
        <label class="control-label" for="f_phone"> Farmer Phone NO:</label >
        <div class="controls">
            <input class="input-xlarge" type="text" placeholder="" name='f_phone'/> 
        </div>
    </div>
    <div class="control-group">
